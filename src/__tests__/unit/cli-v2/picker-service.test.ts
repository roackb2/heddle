...
describe('CliV2PickerService', () => {
  ...
  it('filters cached sessions for the /session choose picker', () => {
    const sessions: ControlPlaneSessionView[] = [
      { id: 'session-1', name: 'Planning', pinned: false, messageCount: 0, turnCount: 0, queuedPromptCount: 0 },
      { id: 'session-2', name: 'Implementation', pinned: true, messageCount: 0, turnCount: 0, queuedPromptCount: 0 },
    ];
