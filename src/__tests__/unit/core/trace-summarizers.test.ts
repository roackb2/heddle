  ...
  it('preserves current built-in trace summary output', () => {
    const trace: TraceEvent[] = [
      ...
      },
      {
        ...
        step: 3,
        timestamp: '2026-05-02T00:00:03.500Z',
      },
      {
        ...
        step: 3,
        timestamp: '2026-05-02T00:00:03.750Z',
      },
      {
    ...
    expect(TraceSummaryService.default().summarizeTrace(trace)).toEqual([
      ...
      'autonomy allow for edit_file (src/generated.ts): allowed by autopilot profile and declared policy envelope',
      'autonomy postflight continue for edit_file (src/generated.ts): observed changes stayed within declared write roots',
