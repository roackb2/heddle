...
Users do not point Heddle at their real Chrome profile. Heddle creates and uses
its own persistent browser profiles inside the workspace state directory.
