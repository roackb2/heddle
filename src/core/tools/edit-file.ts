...
export function createEditFileTool(options: EditFileToolOptions = {}): ToolDefinition {
  ...
  return {
    ...
    async execute(raw: unknown): Promise<ToolResult> {
      ...
      return executeScopedEdit(raw, {
        ...
        rootLabel: 'active workspace root',
        subjectLabel: 'file',
...
export const editFileTool: ToolDefinition = createEditFileTool();
