    ...
    return ChatSessionRepositoryConformance.session(id, {
      ...
      turns: [{
        ...
        delegations: [{
          ...
          status: 'finished',
          outcome: 'done',
          summary: 'The repository boundary is explicit.',
          usage: { inputTokens: 20, outputTokens: 10, totalTokens: 30, requests: 1 },
          startedAt: timestamp.first,
          finishedAt: timestamp.second,
        }],
      }],
      model: 'gpt-5.4',
