...
export type ControlPlaneSessionRunEventEnvelope = AsyncIterableValue<RouterOutputs['controlPlane']['sessionRunEvents']>;
...
export type ControlPlaneSessionRunReference = NonNullable<ControlPlaneSessionRunState['activeRun']>;
...
export type ControlPlanePermissionModeUpdateInput = RouterInputs['controlPlane']['workspacePermissionModeUpdate'];
export type ControlPlanePermissionModeUpdateResult = RouterOutputs['controlPlane']['workspacePermissionModeUpdate'];
export type ControlPlanePermissionMode = ControlPlanePermissionModeUpdateInput['mode'];
