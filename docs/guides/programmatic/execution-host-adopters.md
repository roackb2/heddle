...
5. use its durable lifecycle over an atomic store adapter so `requested`,
   accepted, and terminal checkpoints commit
...
authorized scope and durable invocation identity. It can delegate to
